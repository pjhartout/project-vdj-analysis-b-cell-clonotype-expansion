...
sclerosis (RRMS) patiens that were either treated with the antibody natalizumab or
without as well as healthy donors. These were categorised according to two 
...
In a next step we assessed the descriptive statistics of the cell-level and saw that the 
...
split up by Diagnosis we ddidn't observe a clear trend apart from AP cells being
...
expanded if it has $\geq 2$ cells) we saw that indeed AP cells were more expanded
