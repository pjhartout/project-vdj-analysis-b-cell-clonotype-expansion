...
MS is the relapsing-remitting MS (*RRMS*) which is characterised by active
phases of the disease (relapse; *REL*) and inactive phases (remission; *REM*)
[@jelcic].

There is a broad consensus that MS is due to a dysregulated adaptive immunity,
since there is a number of mutations (>100) in genetic loci whose products are
linked to adaptive immunity associated to MS. One important haplotype is
*HLA-DR15*, which has been shown to have a strong association with MS. Since
HLA-DR proteins on the surface of antigen presenting cells drive the activation
of T-cells, thereby restricting the space of possible T cells activated, a
strong argument for HLA-DR15 and the role of adaptive immunity in MS can be
made [@jelcic].
...
autoantibody-producing B-cells. A phenomenon called autoproliferation (*AP*) of T
cells and B cells plays an important role in MS, since it leads to an expansion 
of self-reacting immune cells. Autoproliferation is mediated by memory B-cells, 
since B cells are known to present autoantigen to T cells 
(via, for instance, HLA-DR15). This
mechanism is further corroborated by the fact that the depletion of B-cells
leads to reduced T cell autoproliferation, and is one of the principles behind B
cell-depleting therapies [@dendrou2015immunopathology]. Previous studies have
found that the frequency of AP cells was different between stages of RRMS, being
higher in REL than in REM [@jelcic]. This underpins the importance of our choice
to focus on B cells in this project.
...
classes known as *isotypes*. The most important isotypes are 
IgM, IgD, IgG, IgA and IgE.
Upon binding, the B-cell will differentiate into plasmocytes
--a type of effector cell-- that later on produce immunoglobulins (Ig).
The secreted Ig are of the same isotype as the BCR and bind their target
antigens [@janeway].
...
clonotypes, which are populations of very similar, clonally expanded cells.
[@janeway].
...
containing high concentrations of *CFSE*. The reduction in dye concentration is attributed to the successive halving of CFSE molecule concentration upon each 
division cycle.
...
of clonotype frequency in *AP* and *nonAP*; fourth we perform an analysis of the 
isotype frequencies in *AP* and *nonAP*.
