...
We see that we have in the range of cell counts in the range of $\sim$ 1000 up
to $\sim$ 5000. Over the two conditions AP and nonAP we see that the
distribution is quite similar with `r cells_ap`AP cells and `r cells_nonap`
