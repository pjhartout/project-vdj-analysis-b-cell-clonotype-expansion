...
p <- ggplot(countlabel, aes(x = variable, y= value, fill = label)) +
  ...
  xlab("Patient ID") + ylab ("Count") + ggtitle("Visualisation of cell count per
                                                patient")
...
p <- ggplot(summary.df, aes(x = "", y = value, fill = Type)) + geom_bar(stat = "identity") + xlab ("Cumsum of Cells")
p
```
