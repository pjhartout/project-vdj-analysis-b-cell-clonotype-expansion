...
expansion of self-reacting immune cells. Autoproliferation is mediated by memory
B-cells, since B cells are known to present autoantigen to T cells (via, for
