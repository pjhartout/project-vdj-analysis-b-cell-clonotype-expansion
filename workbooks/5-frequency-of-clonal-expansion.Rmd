...
Plotted below are the absolute counts of clonal expansion grouped by sample type and the proportion of clonal expansion grouped by sample type and diagnosis.
...
anomalous, with less expansion than the others. It is again IJ028 that we
...
Here we again see the increase in the frequency of `AP` vs `nonAP` but no 
pattern with respect to diagnosis.
